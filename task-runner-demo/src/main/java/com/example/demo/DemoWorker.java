...
import com.example.sdk.worker.TaskRunnerWorker;
...
public class DemoWorker {
    ...
    public static void main(String[] args) {
        ...
        TaskRunnerWorker worker = new TaskRunnerWorker("127.0.0.1", 8888, workerId,
        ...
        worker.setServerRequestProcessor(request -> {
            ...
            String cmd = TaskRunner.decodeBody(request, String.class);
